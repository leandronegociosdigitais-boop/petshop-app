          ...
          <div className="grid grid-cols-1 gap-4 p-6 sm:grid-cols-2 lg:grid-cols-5">
            <div className="rounded-xl border border-emerald-200 bg-emerald-50 p-5 shadow-sm">
              <div className="flex items-center justify-between">
                ...
                <div className="flex h-12 w-12 items-center justify-center rounded-full bg-emerald-100 text-emerald-600"><TrendingUp size={24} /></div>
              </div>
            </div>
            <div className="rounded-xl border border-red-200 bg-red-50 p-5 shadow-sm">
              <div className="flex items-center justify-between">
                ...
                <div className="flex h-12 w-12 items-center justify-center rounded-full bg-red-100 text-red-600"><TrendingDown size={24} /></div>
              </div>
            </div>
            <div className={`rounded-xl border p-5 shadow-sm ${lucro >= 0 ? 'border-indigo-200 bg-indigo-50' : 'border-red-200 bg-red-50'}`}>
              <div className="flex items-center justify-between">
                ...
                <div className={`flex h-12 w-12 items-center justify-center rounded-full ${lucro >= 0 ? 'bg-indigo-100 text-indigo-600' : 'bg-red-100 text-red-600'}`}><DollarSign size={24} /></div>
              </div>
            </div>
            <div className="rounded-xl border border-amber-200 bg-amber-50 p-5 shadow-sm">
              <div className="flex items-center justify-between">
                ...
                <div className="flex h-12 w-12 items-center justify-center rounded-full bg-amber-100 text-amber-600"><FileText size={24} /></div>
              </div>
            </div>
            <div className="rounded-xl border border-blue-200 bg-blue-50 p-5 shadow-sm">
              <div className="flex items-center justify-between">
                ...
                <div className="flex h-12 w-12 items-center justify-center rounded-full bg-blue-100 text-blue-600"><Users size={24} /></div>
              </div>
            </div>
          </div>
        )}
