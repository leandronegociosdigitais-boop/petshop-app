          ...
          <div className="grid grid-cols-1 gap-4 p-4 sm:p-6 sm:grid-cols-2 lg:grid-cols-5">
            <div className="rounded-xl border border-emerald-200 bg-emerald-50 p-5 shadow-sm">
              ...
              <div className="mt-2 flex flex-col gap-2">
                <p className="text-xl font-bold truncate text-emerald-800">{formatCurrency(totalEntradas)}</p>
            ...
            <div className="rounded-xl border border-red-200 bg-red-50 p-5 shadow-sm">
              ...
              <div className="mt-2 flex flex-col gap-2">
                <p className="text-xl font-bold truncate text-red-800">{formatCurrency(totalSaidas)}</p>
            ...
            <div className={`rounded-xl border p-5 shadow-sm ${lucro >= 0 ? 'border-indigo-200 bg-indigo-50' : 'border-red-200 bg-red-50'}`}>
              ...
              <div className="mt-2 flex flex-col gap-2">
                <p className={`text-xl font-bold truncate ${lucro >= 0 ? 'text-indigo-800' : 'text-red-800'}`}>{formatCurrency(lucro)}</p>
            ...
            <div className="rounded-xl border border-amber-200 bg-amber-50 p-5 shadow-sm">
              ...
              <div className="mt-2 flex flex-col gap-2">
                <p className="text-xl font-bold truncate text-amber-800">{formatCurrency(totalComissoes)}</p>
            ...
            <div className="rounded-xl border border-blue-200 bg-blue-50 p-5 shadow-sm">
              ...
              <div className="mt-2 flex flex-col gap-2">
                <p className="text-xl font-bold truncate text-blue-800">{uniqueClientes}</p>
